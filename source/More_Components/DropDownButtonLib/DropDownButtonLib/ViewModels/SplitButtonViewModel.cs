namespace DropDownButtonLib.ViewModels
{
  ...
  /// </summary>
  public class SplitButtonViewModel : Base.BaseViewModel
  {
    #region fields
    ...
    private int mSliderValue, mBackupSliderValue;
    ...
    public string SelectedItem
    {
      get
      {
        return "Demo Value " + this.mSliderValue;
      }
    }
    ...
    {
      this.mBackupSliderValue = this.mSliderValue;
      this.IsOpen = false;

      string source = "SplitButtonItem";

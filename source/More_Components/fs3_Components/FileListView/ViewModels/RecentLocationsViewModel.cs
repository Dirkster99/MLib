namespace FileListView.ViewModels
{
    ...
    public class RecentLocationsViewModel : Base.ViewModelBase
    {
        ...
        /// </summary>
        /// <param name="folderPath"></param>
        internal void RemoveRecentFolder(IPathModel folderPath)
        {
            lock (this.mLockObject)
            {
                if (folderPath == null)
        ...
        internal void RemoveRecentFolder(string path)
        {
            try
            {
                this.RemoveRecentFolder(PathFactory.Create(path, FSItemType.Folder));
            }
            catch
            {
            }
        ...
        private void ChangeOfDirectoryCommand_Executed(FSItemViewModel path)
        {
            ...
            if (this.RequestChangeOfDirectory != null)
                this.RequestChangeOfDirectory(this, new FolderChangedEventArgs(PathFactory.Create(path.FullPath, FSItemType.Folder)));
        }

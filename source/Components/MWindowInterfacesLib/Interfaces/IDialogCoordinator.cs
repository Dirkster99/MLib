namespace MWindowInterfacesLib.Interfaces
{
    ...
    /// parent window.
    /// See also <seealso cref="IDialogManager"/>
    /// </summary>
    public interface IDialogCoordinator
    {
        ...
        /// <exception cref="System.InvalidOperationException">The <paramref name="dialog"/> is already visible in the window.</exception>

namespace MWindowLib.Controls
{
    ...
    /// </summary>
    public class MWResizeGrip : Thumb
    {
        #region fields
        ...
        static MWResizeGrip()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(MWResizeGrip),
                                                     new FrameworkPropertyMetadata(typeof(MWResizeGrip)));
        }
        ...
        private void MResizeGrip_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            var control = sender as Controls.MWResizeGrip;

namespace Doc.DocManager
{
    ...
    internal class FileManagerServiceImpl : IFileManager
    {
        #region fields
        ...
        public IDocumentType RegisterDocumentType(string Key,
                                                  ...
                                                  int sortPriority = 0)
        {
            var newFileType = new DocumentType(Key
                                              ,Description
                                              ,FileFilterName
                                              ,DefaultFilter
                                              //// ,FileOpenMethod
        ...
        public IFileItem GetFileItem(string fileName)
        {
            string path = System.IO.Path.GetDirectoryName(fileName);
            string file = System.IO.Path.GetFileName(fileName);

            return new FileItem(path, file);
        }
        #endregion Methods
    }
}

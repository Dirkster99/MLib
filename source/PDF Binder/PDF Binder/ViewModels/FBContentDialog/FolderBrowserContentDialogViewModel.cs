namespace PDF_Binder.ViewModels.FBContentDialog
{
    ...
    public class FolderBrowserContentDialogViewModel : Base.ViewModelBase,
                                                       IBaseMetroDialogFrameViewModel<int>
    {
        ...
        public ICommand CloseCommand
        {
            get
            {
                ...
                {
                    this._CloseCommand = new Base.RelayCommand<object>((p) =>
                    {
        ...
        public ICommand OKCommand
        {
            get
            {
                ...
                {
                    this._OKCommand = new Base.RelayCommand<object>((p) =>
                    {

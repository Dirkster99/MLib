namespace MWindowDialogLib.Internal
{
    ...
    {
        private readonly IMetroWindowService _metroWindowService = null;

        #region constructors
        /// <summary>
        /// Class Constructor
        /// </summary>
        public DialogManager(IMetroWindowService metroWindowService)
        {
            _metroWindowService = metroWindowService;
        }
